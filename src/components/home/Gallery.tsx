...
const IMAGES = [
  {
    ...
    alt: 'English breakfast in cast iron',
  ...
  { src: '/images-webp/2.webp', alt: 'Biryani in clay pot', className: 'col-span-1 row-span-1' },
  {
    ...
    alt: 'Breakfast spread overhead',
    className: 'col-span-1 row-span-1',
  },
  {
    src: '/images-webp/pizza.webp',
    alt: 'Pizza top-down view',
    className: 'col-span-1 row-span-2',
  },
    ...
    <section id="gallery" className="section-padding bg-surface-900">
      <div className="container-site">
        ...
        <div className="text-center mb-14">
          <div className="w-10 h-0.5 bg-brand mx-auto mb-6 cursor-pointer" />
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white">Our Kitchen</h2>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 auto-rows-[200px] md:auto-rows-[240px] gap-3">
          {IMAGES.map((img) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-black/10 group-hover:bg-black/0 transition-colors duration-500 cursor-pointer" />
            </div>
          ))}
        </div>
      </div>
